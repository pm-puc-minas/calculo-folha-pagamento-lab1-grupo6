...
class FolhaDePagamentoControllerTest {
    ...
    void deveGerarFolhaERetornarOk() {
        ...
        var userEntity = new User(funcionarioId, "email@test.com", "pwd", Role.USER, "Nome", "12345678900");
        AuthenticatedUser user = new AuthenticatedUser(userEntity);
        ...
        when(service.gerarFolhaDePagamento(request, funcionarioId)).thenReturn(folha);
